...
public class TestActivity extends Activity {
    ...
    private CountDownTimer mTimer = new CountDownTimer(AppConstants.TEST_MINUTE, 1000){
        ...
        public void onTick(long millisUntilFinished) {
            ...
            txtComment.setText(DateUtils.formatElapsedTime(seconds));
        ...
        public void onFinish() {
            ...
            DialogUtils.confirm(TestActivity.this, "Test finished.", new DialogInterface.OnClickListener() {
                @Override
